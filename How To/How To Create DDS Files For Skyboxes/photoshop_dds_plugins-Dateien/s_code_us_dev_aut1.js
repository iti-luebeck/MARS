...
s.linkInternalFilters="javascript:,nvidia.com,slizone.com,nzone.com,nvidia.cn,nvidia.de,nvidia.es,nvidia.fr,nvidia.in,nvidia.co.in,nvidia.it,nvidia.co.jp,nvidia.pl,nvidia.ru,nvidia.co.uk,nzone.fr,nzone.in,slizone.cn,slizone.ru,nvidia.se,nvidia.com.tw,speakvisual.com,intelsinsides.com"
...
if(d.indexOf('.com.br')>-1||d.indexOf('.co.in')>-1||d.indexOf('.co.jp')>-1||d.indexOf('.com.mx')>-1||d.indexOf('.com.tw')>-1||d.indexOf('.co.uk')>-1||d.indexOf('.co.kr')>-1)
...
s.queryVarsList="partner,CMP,rssid,cid,gclid,seid"     // query parameters to keep
...
/* Plugin Example: getNewRepeat 1.0 */
	...
	/* External Campaigns */
	if(!s.campaign)
		s.campaign=s.getQueryParam('cid,CMP,id,siteid,pageid,adid,creativeid,rssid,gclid,seid');
