...
public class GenericTreeModel implements TreeModel{
    ...
    public boolean isLeaf(Object node) {
        if(node instanceof AUV_Manager){
            return false;
        }else if(node instanceof MARS_Settings){
            return false;
        }else if(node instanceof PhysicalEnvironment){
            return false;
        }else if(node instanceof SimObjectManager){
            return false;
        }else if(node instanceof SimObject){
            return false;
        }else if(node instanceof KeyConfig){
            return false;
