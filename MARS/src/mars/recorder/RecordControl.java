...
public class RecordControl extends AbstractControl{
    ...
    public RecordControl(RecordManager recordManager, AUV auv, MARSView view){
        ...
        this.view = view;
        view.initTimeline(records.size());
    }
            ...
            if(records != null){
                if(index < records.size()-1){
                    ...
                    if(diffRecTime <= time){//warte bis genug zeit vergangen ist
                        ...
                        time = 0f;
                        oldRecTime = recTime;
                        view.setTimeline(index);
                        view.setTimelineTime(recTime-startTime);
                    }  
                }else{
                    index = 0;
                }
