...
public class LaserScanner extends Sensor{
    /**
     *
     */
     ...
     *
     */
    protected  Node debug_node = new Node("LaserScanner_Arrow_Debug_Node");
     ...
     * @param simstate 
      ...
      */
    public LaserScanner(SimState simstate, Node detectable,PhysicalEnvironment pe) {
        super(simstate);
        //set the logging
        try {
            // Create an appending file handler
     ...
     * @param detectable object for sonar
     */
    public LaserScanner(SimState simstate, Node detectable) {
        super(simstate);
        //set the logging
        try {
            // Create an appending file handler
