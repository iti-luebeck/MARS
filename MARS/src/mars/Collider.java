...
/**
 * This class can be used when you need to have nodes collidable, and check for them,
 * but cant add them to a second node. Sice The ScenGraph doesn't allow multiple parents
